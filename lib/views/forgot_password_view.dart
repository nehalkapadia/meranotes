...
import 'package:meranotes/utilities/dialog/password_reset_sent_email_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If you have forgot your password, simply enter your email id and we will send the link to reset your password'),
              TextField(
